export const PROMPTS = {
  ...
  SUMMARY: `
    ...
    The recommendation example should be a sentence. 
  `,
  TECHNICAL_SKILLS: `
    ...
    The recommendation example should be comma-separated skills. 
  `,
  NON_TECHNICAL_SKILLS: `
    ...
    The recommendation example should be list of comma-separated skills. 
  `,
  EXPERIENCE: `
